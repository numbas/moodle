...
$string['displayscoresintoc'] = 'Display scores in table of contents';
$string['displayscoresintoc_help'] = 'If enabled, scores are shown in the table of contents.';
$string['displayscoresintocdesc'] = 'If enabled, scores are shown in the table of contents.';
